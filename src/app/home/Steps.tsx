...
export const Steps = () => {
  return (
    <section className="mx-auto mt-8 rounded-1xl bg-gray-400 bg-dot px-8 pb-12 pt-10 lg:mt-2">
      <h1 className="text-center text-2xl font-bold text-red-600">3 Simple Steps</h1>
