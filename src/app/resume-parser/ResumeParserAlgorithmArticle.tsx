...
export const ResumeParserAlgorithmArticle = ({
  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true} className="text-sm">
      ...
      <Paragraph smallMarginTop={true} className="text-sm">
        ...
        <span
          ...
          className="my-2 block text-left text-base text-sm"
        />
      ...
      <Paragraph>
        <span className="text-sm">Written by</span> <Link href="" className="text-red-600 text-b">Our Team</Link><span className="text-sm"> on
        July 2024</span> 
      </Paragraph>
    </article>
  );
